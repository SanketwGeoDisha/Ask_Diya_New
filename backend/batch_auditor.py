    ...
    def export_csv(self, college_name: str, results: List[Dict], summary: Dict) -> bool:
        ...
        try:
            ...
            with open(csv_path, 'w', newline='', encoding='utf-8') as f:
                ...
                f.write(f'Populated Percentage,{summary.get("populated_percentage", 0)}%\n')
                f.write('\n')
    ...
    def export_consolidated_summary(self, all_results: List[Dict]) -> bool:
        ...
        try:
            ...
            with open(summary_csv, 'w', newline='', encoding='utf-8') as f:
                writer = csv.writer(f)
                writer.writerow([
                    'College Name', 'Status', 'Total KPIs', 'Data Found', 'Populated %',
                ...
                for result in all_results:
                    writer.writerow([
                        ...
                        result.get('summary', {}).get('populated_percentage', 0),
...
class BatchAuditProcessor:
    ...
    def _generate_summary(self, results: List[Dict]) -> Dict[str, Any]:
        ...
        # Count data availability - EXCLUDE N/A values from found count
        na_count = 0
        found_count = 0
        error_count = 0
        ...
        for r in results:
            value = str(r.get('value', '')).strip().lower()
            if value not in ['n/a', 'not available', 'data not found', 'error', 'processing error', '']:
...
async def main():
    ...
    config = AutomationConfig(
        ...
        max_concurrent_audits=1,  # Process 1 college at a time (sequential)
        retry_on_failure=True,
        max_retries=2,
        delay_between_audits=3.0,  # 3 seconds between colleges
